...
public class ASMTransformer implements IClassTransformer
{
    ...
    class transformer002 extends ClassVisitor
    {
        ...
        class method001 extends MethodVisitor
        {
            ...
            {
                if (opcode == Opcodes.INVOKEVIRTUAL && target.match(name, desc) && lastALOAD == 10)
                {
                    this.visitInsn(Opcodes.POP);
                    this.visitVarInsn(Opcodes.ALOAD, 7);
                    this.visitVarInsn(Opcodes.ALOAD, 10);
                    ...
                    this.visitVarInsn(Opcodes.ASTORE, 10);
                    this.visitVarInsn(Opcodes.ALOAD, 10);
                }
        ...
        ObfHelper m001 = ObfHelper.newMethod("func_180543_a", "net/minecraft/client/renderer/tileentity/TileEntitySkullRenderer", "(FFFLnet/minecraft/util/EnumFacing;FILcom/mojang/authlib/GameProfile;I)V").setDevName("renderSkull");
    ...
    class transformer003 extends ClassVisitor
    {
        ...
        class method001 extends MethodVisitor
        {
            ...
            public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf)
            {
                ...
                {
                    this.visitVarInsn(Opcodes.ASTORE, 33);
                    this.visitVarInsn(Opcodes.ALOAD, 26);
                    this.visitVarInsn(Opcodes.ALOAD, 33);
